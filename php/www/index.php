...
<body>
  ...
  <section style="max-width:80%;margin: 0 auto; padding-bottom:30px;">
    <p><strong>Docker Settings:</strong></p>
    <ul>
        <li>Path to PHP Configuration file: configuration/php.ini</li>
        <li>Path to MySql dump file: mysql/dump/default.sql</li>
        <li>Php Version: 8.1.19-apache</li>
